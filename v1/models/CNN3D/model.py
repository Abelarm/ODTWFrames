...
from tensorflow.keras.layers import Conv3D, MaxPooling3D, BatchNormalization, Activation, Dense, Flatten
...
def get_model(x_dim, y_dim):
    ...
    conv_1 = Conv3D(32, 3, padding='same', activation='relu',
                    kernel_initializer="he_normal",
                    input_shape=x_dim)(input_layer)
    max_1 = MaxPooling3D()(conv_1)

    conv_2 = Conv3D(64, 3, padding='same',
                    kernel_initializer="he_normal",
    ...
    if act_1.shape[2] == 1:
        ...
        max_2 = MaxPooling3D()(act_1)

    conv_3 = Conv3D(128, 3, padding='same',
                    activation='relu',
                    kernel_initializer="he_normal",
                    kernel_regularizer=l2(0.1))(max_2)

    conv_4 = Conv3D(256, 3, padding='same',
