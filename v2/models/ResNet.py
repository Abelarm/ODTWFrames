...
class ResNet_DTW(LightningModule):
    ...
    def __init__(self, ref_size, channels, window_size, lr=0.0001):
        ...
        self.model = nn.Sequential(
            ResidualBlock(in_channels=channels, out_channels=n_feature_maps),
            ResidualBlock(in_channels=n_feature_maps, out_channels=n_feature_maps * 2),
            ResidualBlock(in_channels=n_feature_maps * 2, out_channels=n_feature_maps * 2),
            ResidualBlock(in_channels=n_feature_maps * 2, out_channels=n_feature_maps * 4),
